<div class="megamenu_wrapper_full megamenu_vtp_theme clear-block">
  <div class="megamenu_container megamenu_vtp clear-block">
    <ul class="megamenu clear-block" id="mainmenu">
      ...
      <li class="menuitem_nodrop"><a href="<?php echo $cms_url;?>/about.php"
	...
	<!--<div class="dropdown_1column">
      ...
      <li><a href="<?php echo $cms_url;?>/team.php"
	     title="Our Team">team</a>
	<div class="dropdown_2columns">
	  <div class="col_full firstcolumn">
	    <ul class="clear-block">
	      <!-- NOTE: I hope for these links to be generated automatically from the database in future versions -->
	      <li><a href="team.php?id=mcgill&name=McGill University">McGill
		  University</a>
		<ul>
		  <li><a href="team.php?id=cbradley&name=Catherine Bradley">Catherine
		      Bradley</a>
		  </li>
		  <li><a href="team.php?id=ssinclair&name=Stefan Sinclair">Stefan
		      Sinclair</a>
		  </li>
		  <li><a href="team.php?id=mmilner&name=Matthew Milner">Matthew
		      Milner</a>
		  </li>
		  <li><a href="team.php?id=pdavoust&name=Peter Davoust">Peter
		      Davoust</a>
		  </li>
		  <li><a href="team.php?id=jeidelman&name=Jonathan Eidelman">Jonathan Eidelman</a>
		  </li>
		  <li><a href="team.php?id=pcaussy&name=Pamela Caussy">Pamela Caussy</a>
		  </li>
		</ul>
	      </li>
	      <li><a href="team.php?id=danp">Dragon
		  and Phoenix Software</a>
		<ul>
		  <li><a href="team.php?id=klind">Kat Lind</a>
		  </li>
		</ul>
	      </li>
	    </ul>
      ...
      <li class="menuitem_nodrop"><a href="<?php echo $cms_url;?>/blog.php"
